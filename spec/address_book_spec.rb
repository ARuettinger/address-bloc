...
RSpec.describe AddressBook do 
	...
	context "importing from entries_2.csv" do
		...
		it "imports the 1st entry" do
			...
			# Check the first entry
			entry_one = book.entries[0]
			check_entry(entry_one, "Admiral", "555-555-6379", "admiraladama@sosayweall.com")
		end
		...
		it "imports the 2nd entry" do
			...
			# Check the second entry
			entry_two = book.entries[1]
			check_entry(entry_two, "Gaius", "555-555-3759", "gbaltar@cylonlove.com")
		end
		...
		it "imports the 3rd entry" do
			...
			# Check the third entry
			entry_three = book.entries[2]
			check_entry(entry_three, "Kara", "555-555-4862", "starbuck@sosayweall.com")
		end
	end
